...
class DataSetParser(object):
    ...
    def PCA_expansion(self, iq_mat):
        ...
        for expansion_index in range(5):
            ...
            KL_mat[:, -NUMBER_OF_KL_COEEFIECENT:] = np.multiply(KL_mat[:, -NUMBER_OF_KL_COEEFIECENT:], np.random.uniform(1-VARIANCE_OF_NOISE,1+VARIANCE_OF_NOISE,(32, NUMBER_OF_KL_COEEFIECENT)))
