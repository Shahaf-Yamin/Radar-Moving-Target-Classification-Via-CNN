...
class DataSetParser(object):
    ...
    def PCA_expansion(self, iq_mat):
        ...
        for expansion_index in range(self.config.num_of_pca_segments):
            ...
            KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] = KL_mat[:,:NUMBER_OF_KL_COEEFIECENT] + VARIANCE_SCALING * np.multiply(KL_mat[:,:NUMBER_OF_KL_COEEFIECENT],((1/(np.sqrt(2)))*np.random.randn(32, NUMBER_OF_KL_COEEFIECENT)))
