...
def load_data(config):
    ...
    if config.with_interpolation_fast_axis is True:
        train_data = expand_data_by_interpolation_fast_axis(data_parser=data_parser, train_data=train_data, validation_segments_id_list=validation_data[1]['segment_id'])
    elif config.with_interpolation_slow_axis is True:
