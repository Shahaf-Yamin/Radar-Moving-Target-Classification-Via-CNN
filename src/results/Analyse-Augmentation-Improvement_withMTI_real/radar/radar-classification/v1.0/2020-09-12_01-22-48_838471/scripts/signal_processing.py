...
def kalman_filter_clean_algorithm(iq_mat):
    ...
    measurment_uncertaintiy[70:90] = 0.2
    measurment_uncertaintiy[90:] = 0.4
    measurment_uncertaintiy[30:50] = 0.2
    measurment_uncertaintiy[0:30] = 0.4
    main_diag = np.ones((1,iq_mat.shape[0]))[0]
    Filter.H = np.diag(main_diag,0)
