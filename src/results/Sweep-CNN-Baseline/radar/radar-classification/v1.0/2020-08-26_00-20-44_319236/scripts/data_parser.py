...
class DataSetParser(object):
    ...
    def interpolation(self, iq_time_matrix):
        ...
        '''
        interpolated_iq_time_func_real = interpolate.interp2d(mesh_slow_axis, mesh_fast_axis, np.real(iq_time_matrix), kind='cubic')
        interpolated_iq_time_func_imag = interpolate.interp2d(mesh_slow_axis, mesh_fast_axis, np.imag(iq_time_matrix), kind='cubic')
