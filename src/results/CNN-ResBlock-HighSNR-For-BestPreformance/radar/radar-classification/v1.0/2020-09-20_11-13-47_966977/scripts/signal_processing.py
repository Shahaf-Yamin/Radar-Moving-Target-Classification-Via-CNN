...
def PCA_expansion(iq_mat,config):
    ...
    KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] = KL_mat[:, :NUMBER_OF_KL_COEEFIECENT].astype(np.complex) + np.sqrt(VARIANCE_SCALING) * (np.multiply(KL_mat[:, :NUMBER_OF_KL_COEEFIECENT],np.random.randn(32, NUMBER_OF_KL_COEEFIECENT)) + 1j * np.multiply(KL_mat[:, :NUMBER_OF_KL_COEEFIECENT],np.random.randn(32, NUMBER_OF_KL_COEEFIECENT)))
