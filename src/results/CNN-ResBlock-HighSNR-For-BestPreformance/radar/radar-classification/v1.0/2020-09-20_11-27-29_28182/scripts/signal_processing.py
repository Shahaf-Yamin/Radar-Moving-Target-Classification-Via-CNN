...
def PCA_expansion(iq_mat,config):
    ...
    KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] = KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] + VARIANCE_SCALING * (np.multiply(KL_mat[:, :NUMBER_OF_KL_COEEFIECENT],np.random.uniform(-1,1,(32, NUMBER_OF_KL_COEEFIECENT))))
