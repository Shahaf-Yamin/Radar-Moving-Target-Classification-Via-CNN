...
class DataSetParser(object):
    ...
    def KLT_aug(self,x, N_req, variance):
        ...
        KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] = KL_mat[:, :NUMBER_OF_KL_COEEFIECENT] + VARIANCE_SCALING * (np.multiply(KL_mat[:, :NUMBER_OF_KL_COEEFIECENT], np.random.normal(loc=0, scale=np.sqrt(2) / 2, size=(32, NUMBER_OF_KL_COEEFIECENT)).view(np.complex128)))
