...
class DataSetParser(object):
    ...
    def plot_histogram(self):
        ...
        axes[0].plot(np.linspace(0, 126, 126),mean_histogram_human)
        axes[0].set(xlabel='Frequency Bin', ylabel='Count')
        ...
        # fig.suptitle('Animal')
        axes[1].plot(np.linspace(0,126, 126),mean_histogram_animal)
        axes[1].set(xlabel='Frequency Bin', ylabel='Count')
